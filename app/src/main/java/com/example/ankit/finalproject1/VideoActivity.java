...
public class VideoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String newString= bundle.getString("Name");
        String root_sd = Environment.getExternalStorageDirectory().toString();
        String file = new String( root_sd + "/" + newString) ;
     ...
     */
    private void handleUri(Uri fileUri1) {
        ...
        backgroundVideoLoaderTask.execute(fileUri1);
    }
    ...
    private class ActivityEventListener extends VrVideoEventListener  {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    VideoActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
        ...
        protected Boolean doInBackground(Uri... uri) {
            try {
                if (uri == null || uri.length < 1 || uri[0] == null) {
                    ...
                    System.out.println("Ankit Gupta" + uri[0]);
                ...
                videoWidgetView.post(new Runnable() {
                    ...
                    public void run() {
                        Toast
                                .makeText(VideoActivity.this, "Error opening file. ", Toast.LENGTH_LONG)
                                .show();
                    }
                });
